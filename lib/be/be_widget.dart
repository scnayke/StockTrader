...
class BeWidget extends StatefulWidget {
  BeWidget({
    Key key,
    this.paramName,
  }) : super(key: key);
  ...
  @override
  _BeWidgetState createState() => _BeWidgetState();
}

class _BeWidgetState extends State<BeWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CategoriesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final beCategoriesRecord = beCategoriesRecordList.first;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                ...
                child: StreamBuilder<List<BeRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewBeRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewBeRecord =
                            listViewBeRecordList[listViewIndex];
                        return Container(
                          height: 90,
                          decoration: BoxDecoration(
