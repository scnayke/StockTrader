...
class BzWidget extends StatefulWidget {
  ...
  @override
  _BzWidgetState createState() => _BzWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CategoriesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final bzCategoriesRecord = bzCategoriesRecordList.first;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                ...
                child: StreamBuilder<List<BzRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewBzRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewBzRecord =
                            listViewBzRecordList[listViewIndex];
                        return Container(
                          height: 90,
                          decoration: BoxDecoration(
