...
class StocklistPageCopyCopyWidget extends StatefulWidget {
  StocklistPageCopyCopyWidget({
    Key key,
    this.paramName,
  }) : super(key: key);
  ...
  @override
  _StocklistPageCopyCopyWidgetState createState() =>
      _StocklistPageCopyCopyWidgetState();
}

class _StocklistPageCopyCopyWidgetState
    extends State<StocklistPageCopyCopyWidget> {
